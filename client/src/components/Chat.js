        ...
        <div className='flex items-center justify-center h-full'>
            <div className='w-1/3 h-[500px] bg-white relative'>
                ...
                <div className='w-full h-[400px] overflow-y-auto'>
                    {
                        ...
                        <div className={`${username === msg.username ? "bg-green-600" : "bg-blue-600"} w-1/2 h-16 p-2 text-white text-sm m-2 rounded-xl rounded-br-none`}>
                            <div>{msg.message}</div>
                ...
                <div className='absolute bottom-0 left-0 w-full'>
                    <input value={message} onChange={e => setMessage(e.target.value)} className='w-3/4 h-12 border outline-none p-3' type="text" placeholder='message send' />
